...
ofile.write("size_t DomeMappings::ShapeIsHex(size_t shape_index, bool& inner)\n")
ofile.write("{   \n")
ofile.write("    for(size_t i=0;i<c_num_double_hex;i++)\n")
ofile.write("    {\n")
ofile.write("        if(shape_index == c_inner_hex_index[i])\n")
ofile.write("        {\n")
ofile.write("            inner = true;\n")
ofile.write("            return true;\n")
ofile.write("        }\n")
ofile.write("\n")
ofile.write("        if(shape_index == c_outer_hex_index[i])\n")
ofile.write("        {\n")
ofile.write("            inner = false;\n")
ofile.write("            return true;\n")
ofile.write("        }\n")
ofile.write("\n")
ofile.write("    }\n")
...
ofile.write("}   \n")
ofile.write("\n")
ofile.write("size_t DomeMappings::ShapeIsOnLeft(size_t shape_index)\n")
ofile.write("{   \n")
ofile.write("    if(shape_index < 9 || shape_index == 18 || shape_index == 20) \n")
ofile.write("    {\n")
ofile.write("        return true;\n")
ofile.write("    }\n")
ofile.write("\n")
